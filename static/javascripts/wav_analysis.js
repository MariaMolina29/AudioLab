...
function main() {
    Swal.fire({
        ...
        didOpen: () => {
            ...
            Plotly.newPlot('spectrum', [], { title: "Esperando Datos...", dragmode: false, font: {family: 'Helvetica Neue'} }, { responsive: true, displayModeBar: true, doubleClick: false, showTips: false, modeBarButtons: [['zoom2d', 'pan2d', 'autoScale2d', 'toImage', 'toggleSpikelines']], locale: 'custom', locales: { custom: custom_locale } });
            Plotly.newPlot('spectrogram_3d', [], { title: "Esperando Datos...", dragmode: false, font: {family: 'Helvetica Neue'} }, { responsive: true, displayModeBar: true, doubleClick: false, showTips: false, modeBarButtonsToRemove: ['pan3d', 'orbitRotation', 'resetCameraDefault3d', 'hoverClosest3d'], locale: 'custom', locales: { custom: custom_locale } });
